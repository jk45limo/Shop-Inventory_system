	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  <a class="nav-link active" id="v-pills-item-tab" data-toggle="pill" href="#v-pills-item" role="tab" aria-controls="v-pills-item" aria-selected="true">Enter inventory</a>
			  <a class="nav-link" id="v-pills-purchase-tab" data-toggle="pill" href="#v-pills-purchase" role="tab" aria-controls="v-pills-purchase" aria-selected="false">Request inventory</a>
			  <a class="nav-link" id="v-pills-vendor-tab" data-toggle="pill" href="#v-pills-vendor" role="tab" aria-controls="v-pills-vendor" aria-selected="false">Manufacturer</a>
			  <a class="nav-link" id="v-pills-sale-tab" data-toggle="pill" href="#v-pills-sale" role="tab" aria-controls="v-pills-sale" aria-selected="false">Dispatch</a>
		 ...
		 <div class="col-lg-10">
			<div class="tab-content" id="v-pills-tabContent">
							...
							<form name="imageForm" id="imageForm" method="post">
							  <div class="form-row">
								...
								<div class="form-group col-md-4">
									<label for="itemImageItemName">Product Name</label>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form>
					  <div class="form-row">
						<div class="form-group col-md-3">
						  <label for="purchaseDetailsItemNumber">Request Number<span class="requiredIcon">*</span></label>
						...
						<div class="form-group col-md-3">
						  <label for="purchaseDetailsPurchaseDate">Request Date<span class="requiredIcon">*</span></label>
						...
						<div class="form-group col-md-2">
						  <label for="purchaseDetailsPurchaseID">Request ID</label>
					  ...
					  <div class="form-row"> 
						  ...
						  <div class="form-group col-md-2">
							  <label for="purchaseDetailsCurrentStock">Current Inventory</label>
							  <input type="text" class="form-control" id="purchaseDetailsCurrentStock" name="purchaseDetailsCurrentStock" readonly>
						  </div>
						  <div class="form-group col-md-4">
							<label for="purchaseDetailsVendorName">Manufacturer Name<span class="requiredIcon">*</span></label>
					  ...
					  <button type="button" id="addPurchase" class="btn btn-success">Add Request</button>
			  ...
			  <div class="tab-pane fade" id="v-pills-vendor" role="tabpanel" aria-labelledby="v-pills-vendor-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">Manufacture Details</div>
				  <div class="card-body">
				  <!-- Div to show the ajax message from validations/db submission -->
					 ...
					 <form> 
					  <div class="form-row">
						...
						<div class="form-group col-md-2">
						 ...
						 <div class="form-group col-md-3">
							<label for="vendorDetailsVendorID">Manufacturer ID</label>
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-4">
						  <label for="vendorDetailsVendorDistrict">County</label>
					  ...
					  <button type="button" id="addVendor" name="addVendor" class="btn btn-success">Add Manufacturer</button>
			  ...
			  <div class="tab-pane fade" id="v-pills-sale" role="tabpanel" aria-labelledby="v-pills-sale-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">Dispatch Details</div>
				  <div class="card-body">
					...
					<form>
					  <div class="form-row">
						...
						<div class="form-group col-md-2">
						  <label for="saleDetailsSaleID">Dispatch ID</label>
					  ...
					  <div class="form-row">
						  ...
						  <div class="form-group col-md-3">
							  <label for="saleDetailsSaleDate">Dispatch Date<span class="requiredIcon">*</span></label>
							  <input type="text" class="form-control datepicker" id="saleDetailsSaleDate" value="" name="saleDetailsSaleDate" readonly>
						  </div>
					  </div>
					  <div class="form-row">
						<div class="form-group col-md-2">
								  <label for="saleDetailsTotalStock">Total Inventory</label>
					  ...
					  <button type="button" id="addSaleButton" class="btn btn-success">Add Dispatch</button>
				  ...
				  <div id="customerDetailsMessage"></div>
					 <form> 
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-4">
						  <label for="customerDetailsCustomerDistrict">County</label>
			  ...
			  <div class="tab-pane fade" id="v-pills-search" role="tabpanel" aria-labelledby="v-pills-search-tab">
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#itemSearchTab">Product</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#customerSearchTab">Customer</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#saleSearchTab">Dispatch</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#purchaseSearchTab">Request</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#vendorSearchTab">Manufacturer</a>
						</li>
					</ul>
					...
					<div class="tab-content">
						<div id="itemSearchTab" class="container-fluid tab-pane active">
						  <br>
						  <p>Use the grid below to search all details of Products</p>
